...
const serviceImages = {
  'septic-tank': '/images/exhauster-service-kisii-septic-tank.jpeg',
  'grease-trap': '/images/exhauster-truck-professional-team.jpeg',
  'pit-latrine': '/images/exhauster-service-emergency.jpeg',
  'emergency': '/images/exhauster-truck-migori-service.jpeg',
  'residential-moving': '/images/moving-services-homabay.jpeg',
  'commercial-moving': '/images/transport-truck-warehouse.jpeg',
  'furniture-transport': '/images/transport-truck-blessing-movers.jpeg',
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Comprehensive exhauster and transport solutions tailored to meet your needs across Kisii, Nyamira, Migori, and Homabay counties.
          </p>
        </div>
